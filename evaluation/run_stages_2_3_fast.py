"""
Run S-ADT evaluation on Stages 2 and 3 using MLX (fast version - 10 rollouts).
"""
...
def main():
    print("\n╔══════════════════════════════════════════════════════════════════╗")
    print("║      🚀 RUNNING STAGES 2 & 3 WITH MLX (FAST VERSION)            ║")
    print("╚══════════════════════════════════════════════════════════════════╝\n")
    ...
    # Configure S-ADT (FASTER: 10 rollouts, expansion_k=3)
    ...
    for stage_num in [2, 3]:
        print(f"\n{'='*70}")
        print(f"  STAGE {stage_num} EVALUATION (Fast)")
        print(f"{'='*70}\n")
        ...
        output_file = f'evaluation/results/stage{stage_num}_mlx_fast.json'
    ...
    # Save aggregate
    aggregate_file = 'evaluation/results/stages_2_3_fast_aggregate.json'
