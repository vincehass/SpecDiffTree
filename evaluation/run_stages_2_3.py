"""
Run S-ADT evaluation on Stages 2 and 3 using MLX.
"""
...
def run_stage(stage_num: int, num_prompts: int = 3, num_rollouts: int = 20):
    ...
    print(f"\n{'='*70}")
    print(f"  🚀 STAGE {stage_num} EVALUATION (MLX)")
    print(f"{'='*70}\n")
    ...
    output_file = f'evaluation/results/stage{stage_num}_mlx.json'
...
if __name__ == "__main__":
    print("\n╔══════════════════════════════════════════════════════════════════╗")
    print("║        🚀 RUNNING STAGES 2 & 3 WITH MLX                         ║")
    print("╚══════════════════════════════════════════════════════════════════╝\n")
